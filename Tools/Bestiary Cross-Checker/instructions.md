...
[the FFFT thread](https://www1.flightrising.com/forums/gde/3416901#post_58979490), highlight from the first familiar name to the last, and copy it all into `feats-list.txt` (overwriting its previous contents).
